package com.athenhub.memberservice;
...
@AnalyzeClasses(
    packages = "com.athenhub.memberservice",
    importOptions = ImportOption.DoNotIncludeTests.class)
class LayeredArchitectureTest {

  private static final String[] DOMAIN_PACKAGES = {
    "com.athenhub.memberservice.example.domain..",
  };
  ...
  public void layeredArchitecture(JavaClasses classes) {
    Architectures.layeredArchitecture()
        ...
        .layer("Presentation")
        .definedBy("com.athenhub.memberservice..presentation..")
        .layer("Application")
        .definedBy("com.athenhub.memberservice..application..")
        .layer("Domain")
        .definedBy("com.athenhub.memberservice..domain..")
        .layer("Infrastructure")
        .definedBy("com.athenhub.memberservice..infrastructure..")
        ...
        .ignoreDependency(
            ...
            JavaClass.Predicates.resideInAPackage("com.athenhub.memberservice.global.."))
        // 빈 레이어 허용
  ...
  public void globalShouldNotDependOnDomains(JavaClasses classes) {
    ...
    // global 패키지가 없으면 스킵
    if (!hasClassesInPackage(classes, "com.athenhub.memberservice.global..")) {
      return;
    }

    noClasses()
        .that()
        .resideInAPackage("com.athenhub.memberservice.global..")
        .should()
        .dependOnClassesThat()
