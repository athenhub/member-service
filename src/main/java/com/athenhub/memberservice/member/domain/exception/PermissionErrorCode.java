 ...
 *
 * <p>각 에러 코드는 HTTP 상태 코드와 애플리케이션 내부 에러 코드를 함께 제공하여, 인가(Authorization) 과정에서 발생하는 권한 부족 상황을 일관되게 표현할
 * 수 있도록 한다.
 *
 * <ul>
 *   <li>{@link #HAS_NOT_REGISTER_PERMISSION} — 등록 작업에 대한 권한이 없는 경우
 *   <li>{@link #HAS_NOT_MANAGE_PERMISSION} — 수정, 삭제, 상태 변경 등 관리 작업에 대한 권한이 없는 경우
 * </ul>
 *
 * @author 박성준
 * @since 1.0.0
