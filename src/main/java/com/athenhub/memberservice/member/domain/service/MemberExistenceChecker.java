 ...
 *   <li>회원 가입 시 {@code username} 이 이미 사용 중인지 확인
 *   <li>회원 가입 시 Slack ID 가 이미 사용 중인지 확인
 * </ul>
 *
 * <p>구현체는 보통 저장소(Repository)나 외부 인증 시스템을 조회하여 실제 존재 여부를 판단하며, 도메인 계층에서는 이 인터페이스에만 의존함으로써 인프라 세부
 * 구현(예: JPA, MyBatis, Keycloak 등)에 대한 결합을 줄인다.
 *
 * @author 박성준
 * @since 1.0.0
 */
